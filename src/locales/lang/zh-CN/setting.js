...
import file from './setting/file'
import pay from './setting/pay'
import integral from './setting/integral'
// import notice from './setting/notice'
export default {
  'system.setting.base': '基础设置',
  'system.setting.file': '附件设置',
  'system.setting.auth': '登录注册',
  'system.setting.user': '用户设置',
  'system.setting.pay': '财富设置',
  'system.setting.integral': '积分设置',
  'system.setting.notice': '通知设置',
  'system.setting.content' : '内容设置',
  'system.setting.save': '保存',
  'system.setting.upload': '上传',
  ...base,
  ...user,
  ...file,
  ...pay,
