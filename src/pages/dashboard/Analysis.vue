  ...
  <div>
    <a-row :gutter="24">
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="总收益" total="￥12520.00">
      ...
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="投稿内容" total="125">
          <a-tooltip title="指标说明" slot="action">
            <a-icon type="info-circle-o" />
          </a-tooltip>
          <div>
          ...
          <template slot="footer">日均投稿数额 <span> 23</span></template>
        </chart-card>
      </a-col>
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
      ...
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="总用户" :total="6560 | NumberFormat">
          <a-tooltip title="指标说明" slot="action">
            <a-icon type="info-circle-o" />
          </a-tooltip>
          <div>
          ...
          <template slot="footer">今日注册 <span>60</span></template>
        </chart-card>
      </a-col>
    </a-row>
    ...
    <a-card :loading="loading" :bordered="false" :body-style="{padding: '0'}">
      <div class="salesCard">
        <a-tabs default-active-key="1" size="large" :tab-bar-style="{marginBottom: '24px', paddingLeft: '16px'}">
          ...
          <a-tab-pane loading="true" tab="用户注册" key="1">
            <bar :data="barData" title="用户注册趋势" />
          </a-tab-pane>
          <a-tab-pane tab="内容投稿" key="2">
            <bar :data="barData2" title="内容投稿趋势" />
          </a-tab-pane>
        </a-tabs>
      </div>
    </a-card>
            ...
            <div slot="extra" style="height: inherit;">
              <div class="analysis-salesTypeRadio">
                <a-radio-group defaultValue="a">
                  ...
                  <a-radio-button value="b">内容购买</a-radio-button>
                  <a-radio-button value="c">用户打赏</a-radio-button>
                </a-radio-group>
              </div>
