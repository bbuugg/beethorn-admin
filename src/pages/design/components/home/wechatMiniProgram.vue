                        ...
                        <Vuedraggable class="wrapper" group="site" v-model="list">
                            <div v-for="(item,index) in list" :key="3234+index"  class="item">
                                ...
                                <div v-if="item.isOpen" class="item-bottom">
                                    ...
                                    <!-- 轮播组件数据添加 -->
                                    <a-row 
                                        v-if="item.style == wechatMiniProgramWidget.swpie"
                                        class="setting-item" 
                                        :gutter="[{md:20},{md:20}]">
                                        <a-col :span="24">
                                    ...
                                    <div v-if="item.style == wechatMiniProgramWidget.swpie">
                                        <a-row 
                                            ...
                                            <a-col :span="5" v-if="citem.isPlatform == 2">
                                                <a-input 
                                                    size="large"
                                                    v-model="citem.appId"
                                                    placeholder="其他小程序appId" 
                                                />
                                            </a-col>
                                            <a-col :span="5">
                                                <a-select 
                                    ...
                                    <!-- 社区组件数据编号 -->
                                    <a-row 
                                        v-if="item.style == wechatMiniProgramWidget.community" 
                                        class="setting-item" 
                                        :gutter="[{md:20},{md:20}]">
                                        <a-col :span="24">
                                            <a-input 
                                    ...
                                    <!-- 文章组件数据 -->
                                    <a-row 
                                        v-if="item.style == wechatMiniProgramWidget.article" 
                                        class="setting-item" 
                                        :gutter="[{md:20},{md:20}]">
                                        <a-col :span="24">
                                            <a-input 
                                    ...
                                    <!-- 课程组件数据 -->
                                    <a-row 
                                        v-if="item.style == wechatMiniProgramWidget.edu" 
                                        class="setting-item" 
                                        :gutter="[{md:20},{md:20}]">
                                        <a-col :span="24">
                                            <a-input 
                                    ...
                                    <!-- 自定义组件数据 -->
                                    <a-row 
                                        v-if="item.style == wechatMiniProgramWidget.custom"
                                        class="setting-item" 
                                        :gutter="[{md:20},{md:20}]">
                                        <a-col :span="24">
                                    ...
                                    <div v-if="item.style == wechatMiniProgramWidget.custom">
                                        <a-row 
                                            v-for="(citem,cindex) in item.list" :key="cindex"
                                            class="setting-item" 
                                            :gutter="[{md:20},{md:20}]">
                                            ...
                                            <a-col :span="4" v-if="citem.isPlatform == 2">
                                                <a-input 
                                                    size="large"
                                                    v-model="citem.appId"
                                                    placeholder="其他小程序AppId"
                                    ...
                                    <!-- 自定义图片组件 -->
                                    <a-row 
                                        v-if="item.style == wechatMiniProgramWidget.image" 
                                        class="setting-item" 
                                        :gutter="[{md:20},{md:20}]">
                                        <a-col :span="8">
                                            <a-input 
                                        ...
                                        <a-col :span="8" v-if="item.isPlatform == 2">
                                            <a-input 
                                                size="large"
                                                v-model="item.appId"
                                                placeholder="其他小程序appId" 
                                    ...
                                    <!-- 自定义投稿内容组件 -->
                                    <a-row 
                                        v-if="item.style == wechatMiniProgramWidget.content" 
                                        class="setting-item" 
                                        :gutter="[{md:20},{md:20}]">
                                        <a-col :span="8">
                                            <a-input 
...
import {wechatMiniProgramWidget} from "@/shared/widget"
export default {
    components: {
        Vuedraggable,
    },
            ...
            widgetList:[
                {
                    ...
                    showTitle:undefined,
                    height:360,
                    style:wechatMiniProgramWidget.swpie,
                    list:[
                        {
                            link:undefined,
                            cover:undefined
                ...
                },
                {
                    ...
                    desc:"",
                    showTitle:2,
                    style:wechatMiniProgramWidget.community,
                    topicIds:"",
                    questionIds:"",
                    isOpen:false
                },
                {
                    ...
                    desc:"",
                    showTitle:2,
                    style:wechatMiniProgramWidget.article,
                    ids:"",
                    isOpen:false
                },
                {
                    ...
                    desc:"",
                    showTitle:2,
                    style:wechatMiniProgramWidget.edu,
                    ids:"",
                    isOpen:false
                },
                {
                    ...
                    showTitle:2,
                    list:[],
                    style:wechatMiniProgramWidget.custom,
                    isOpen:false
                },
                {
                    title:"自定义图片组件",
                    desc:"",
                    showTitle:2,
                    style:wechatMiniProgramWidget.image,
                    content:"",
                    isOpen:false
                },
                {
                    ...
                    desc:"",
                    showTitle:2,
                    style:wechatMiniProgramWidget.content,
                    content:"",
                    isOpen:false
                },
            ]
